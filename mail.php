    ...
    <div class="contact-title">
        ...
        <div class="contact-form">
            <form action="" id="contact-form" method="POST">
                ...
                <input type="text" name="name" class="form-control" palceholder="Your Name" required><br>

                <input type="text" name="email" class="form-control" palceholder="Your Email" required><br>
                <textarea 
                class="form-control" name="message"  rows="4" required></textarea>
                <br>
